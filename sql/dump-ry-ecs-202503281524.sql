...
CREATE TABLE `ecs_community_activity` (
  ...
  PRIMARY KEY (`activity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='社区活动表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ecs_community_activity` VALUES (1,'老年人诗朗诵','老年人诗朗诵','2025-03-31 00:00:00','北京市',100),(2,'老年人合唱团','老年人合唱团','2025-03-31 00:00:00','上海',100);
...
CREATE TABLE `ecs_health_record` (
  ...
  `remarks` varchar(2550) DEFAULT NULL COMMENT '备注',
...
INSERT INTO `ecs_health_record` VALUES (1,1,'2025-03-26','120/80',10.00,37.4,'','');
...
CREATE TABLE `ecs_registration` (
  ...
  PRIMARY KEY (`registration_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='活动报名表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ecs_registration` VALUES (1,1,1,'2025-03-28 10:10:38',1),(2,1,2,'2025-03-28 10:48:12',1),(3,100,1,'2025-03-28 14:51:02',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='服务需求管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ecs_service_request` VALUES (4,1,2,'2025-03-26 17:59:26',2,'2025-03-27 00:00:00','李华','11'),(5,1,2,'2025-03-28 09:04:33',1,'2025-03-31 12:00:00','李华','服务详情'),(6,100,1,'2025-03-28 14:53:10',0,NULL,'','');
...
) ENGINE=InnoDB AUTO_INCREMENT=273 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=269 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通老人用户','common',4,'1',0,1,'0','0','admin','2024-02-28 22:41:32','admin','2025-03-28 15:20:14','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (101,1035),(101,2049),(101,2050),(101,2052),(101,2053),(101,2054),(101,2055),(101,2056),(101,2057),(101,2058),(101,2060),(101,2062),(101,2064),(101,2066),(101,2067),(101,2068);
...
-- Dump completed on 2025-03-28 15:24:20
