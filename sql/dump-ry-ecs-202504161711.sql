...
--
-- Host: localhost    Database: ry-ecs
-- ------------------------------------------------------
...
--
-- Table structure for table `ape_activity_comment`
--

DROP TABLE IF EXISTS `ape_activity_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ape_activity_comment` (
...
--
-- Dumping data for table `ape_activity_comment`
--

LOCK TABLES `ape_activity_comment` WRITE;
/*!40000 ALTER TABLE `ape_activity_comment` DISABLE KEYS */;
INSERT INTO `ape_activity_comment` VALUES (2,1,1,'真不错','2025-01-03 11:00:59'),(3,7,1,'好啊','2025-01-07 09:57:42'),(5,11,108,'真好','2025-01-09 19:56:34'),(6,10,108,'真不崔','2025-01-09 19:56:47');
/*!40000 ALTER TABLE `ape_activity_comment` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='活动报名表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_activity_registration` VALUES (19,4,1,'2025-03-28 10:14:14',0);
...
--
-- Table structure for table `ecs_community_activity`
--

DROP TABLE IF EXISTS `ecs_community_activity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ecs_community_activity` (
  ...
  PRIMARY KEY (`activity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='社区活动表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ecs_community_activity`
--

LOCK TABLES `ecs_community_activity` WRITE;
/*!40000 ALTER TABLE `ecs_community_activity` DISABLE KEYS */;
INSERT INTO `ecs_community_activity` VALUES (1,'老年人诗朗诵','老年人诗朗诵','2025-03-31 00:00:00','北京市',100),(2,'老年人合唱团','老年人合唱团','2025-03-31 00:00:00','上海',100),(3,'老年人乐器比赛','老年人乐器比赛','2025-04-05 00:00:00','珠海市',100);
/*!40000 ALTER TABLE `ecs_community_activity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ecs_health_record`
--

DROP TABLE IF EXISTS `ecs_health_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ecs_health_record` (
  `record_id` bigint NOT NULL AUTO_INCREMENT COMMENT '记录ID，主键',
  `elderly_id` bigint NOT NULL COMMENT '关联老年人ID',
  `record_date` date NOT NULL COMMENT '记录日期',
  `blood_pressure` varchar(20) DEFAULT NULL COMMENT '血压（如120/80）',
  `blood_sugar` decimal(5,2) DEFAULT NULL COMMENT '血糖（单位：mmol/L）',
  `temperature` decimal(4,1) DEFAULT NULL COMMENT '体温（单位：℃）',
  `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  `file_name` varchar(255) DEFAULT NULL COMMENT '健康附件',
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ecs_health_record`
--

LOCK TABLES `ecs_health_record` WRITE;
/*!40000 ALTER TABLE `ecs_health_record` DISABLE KEYS */;
INSERT INTO `ecs_health_record` VALUES (1,1,'2025-04-02','120/80',10.00,37.4,'',''),(2,100,'2025-04-15','120/80',12.00,35.0,'','');
/*!40000 ALTER TABLE `ecs_health_record` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ecs_home`
--

DROP TABLE IF EXISTS `ecs_home`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ecs_home` (
  `home_id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NOT NULL COMMENT '老年人ID',
  `dependents_id` bigint NOT NULL COMMENT '家属ID',
  `relation` tinyint NOT NULL COMMENT '与登记老年人关系（1-配偶，2-子女，3-兄弟姐妹，4-其他）',
  PRIMARY KEY (`home_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='家属关系表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ecs_home`
--

LOCK TABLES `ecs_home` WRITE;
/*!40000 ALTER TABLE `ecs_home` DISABLE KEYS */;
INSERT INTO `ecs_home` VALUES (1,100,103,1);
/*!40000 ALTER TABLE `ecs_home` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ecs_registration`
--

DROP TABLE IF EXISTS `ecs_registration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ecs_registration` (
  `registration_id` bigint NOT NULL AUTO_INCREMENT COMMENT '报名ID，主键',
  `elderly_id` bigint NOT NULL COMMENT '关联老年人ID',
  `activity_id` bigint NOT NULL COMMENT '关联活动ID',
  `register_time` datetime NOT NULL COMMENT '报名时间',
  `status` tinyint NOT NULL COMMENT '预约状态（1-已预约，0-已取消）',
  PRIMARY KEY (`registration_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='活动报名表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ecs_registration`
--

LOCK TABLES `ecs_registration` WRITE;
/*!40000 ALTER TABLE `ecs_registration` DISABLE KEYS */;
INSERT INTO `ecs_registration` VALUES (1,1,1,'2025-03-28 10:10:38',1),(2,1,2,'2025-03-28 10:48:12',1),(3,100,1,'2025-03-28 14:51:02',1),(4,102,2,'2025-04-02 17:34:35',1),(5,102,1,'2025-04-02 17:34:37',1),(6,1,3,'2025-04-03 08:56:12',1);
/*!40000 ALTER TABLE `ecs_registration` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ecs_service_request`
--

DROP TABLE IF EXISTS `ecs_service_request`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ecs_service_request` (
  `request_id` bigint NOT NULL AUTO_INCREMENT COMMENT '请求ID，主键',
  `elderly_id` bigint NOT NULL COMMENT '关联老年人ID',
  `service_type` tinyint NOT NULL COMMENT '服务类型 (1: 家政服务, 2: 医疗护理, 3: 日常陪伴)',
  `request_time` datetime NOT NULL COMMENT '预约时间',
  `status` tinyint NOT NULL COMMENT '请求状态 (0: 待审核, 1: 已批准, 2: 已完成, 3: 已取消)',
  `service_time` datetime DEFAULT NULL COMMENT '服务时间',
  `service_personnel` varchar(100) DEFAULT NULL COMMENT '服务人员',
  `details` varchar(255) DEFAULT NULL COMMENT '服务详细信息',
  PRIMARY KEY (`request_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='服务需求管理表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ecs_service_request`
--

LOCK TABLES `ecs_service_request` WRITE;
/*!40000 ALTER TABLE `ecs_service_request` DISABLE KEYS */;
INSERT INTO `ecs_service_request` VALUES (4,1,2,'2025-03-26 17:59:26',2,'2025-03-27 00:00:00','李华','11'),(5,1,2,'2025-03-28 09:04:33',1,'2025-03-31 12:00:00','李华','服务详情'),(6,100,1,'2025-03-28 14:53:10',0,NULL,'',''),(7,1,1,'2025-03-31 15:28:02',0,NULL,'',''),(8,102,2,'2025-04-03 09:05:43',0,NULL,'','');
/*!40000 ALTER TABLE `ecs_service_request` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_notice` VALUES (1,'欢迎大家预约','2',_binary '<p>新的诗词交流活动开放啦，欢迎大家积极预约</p>','0','admin','2024-02-28 22:23:43','admin','2025-01-06 09:29:43','管理员'),(2,'系统维护','1',_binary '<p>系统维护中，两天后正常开放</p>','0','admin','2024-02-28 22:23:43','admin','2025-04-02 17:27:06','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=286 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通老人用户','common',4,'1',0,1,'0','0','admin','2024-02-28 22:41:32','admin','2025-04-16 17:10:01','普通用户'),(102,'家属用户','home',3,'1',0,1,'0','0','admin','2025-04-16 15:35:29','admin','2025-04-16 17:05:42',NULL);
...
INSERT INTO `sys_role_menu` VALUES (101,1035),(101,2049),(101,2050),(101,2052),(101,2053),(101,2054),(101,2055),(101,2056),(101,2057),(101,2058),(101,2060),(101,2062),(101,2064),(101,2066),(101,2067),(101,2068),(101,2073),(102,107),(102,2049),(102,2050),(102,2056),(102,2073),(102,2075),(102,2076);
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-04-16 17:07:44','admin','2024-02-28 22:23:42','','2025-04-16 17:07:44','管理员',390.00,NULL,NULL),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL,NULL,NULL),(100,100,'zhangsan','张三','00','34576@qq.com','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','0','127.0.0.1','2025-03-28 15:19:20','admin','2024-03-04 18:58:34','admin','2025-03-28 15:19:19',NULL,10.00,NULL,NULL),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','0','',NULL,'admin','2024-03-04 18:58:57','admin','2025-01-09 20:13:26',NULL,10.00,NULL,NULL),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','127.0.0.1','2025-04-03 09:01:50','admin','2024-03-04 18:59:22','admin','2025-04-03 09:01:50',NULL,9610.00,NULL,NULL),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','127.0.0.1','2025-04-16 17:06:27','admin','2024-03-04 18:59:55','admin','2025-04-16 17:06:26',NULL,10000.00,NULL,NULL),(104,NULL,'fanjiaxing','fanjiaxing','00','','','0','','$2a$10$eyzwvhBbnWSUIf8.AxTXJONb9j/WV3c3s2oUiSCTmUhe.iN6eQdVK','0','2','127.0.0.1','2024-03-18 10:21:10','','2024-03-18 10:20:59','','2024-03-18 10:21:10',NULL,NULL,NULL,NULL),(105,NULL,'fanjiaxing','fanjiaxing','00','','','0','','$2a$10$dQhzINJKANvGEgCekejN2.SI6sJomoBbiX5tmi.msdmhHVP9rk0ou','0','2','',NULL,'','2024-03-18 11:09:21','admin','2025-01-07 09:56:43',NULL,NULL,NULL,NULL),(106,NULL,'张夜猫','张夜猫','00','','','0','','$2a$10$5eh4CwLns/GDKDBorKQA2uAsjQAswonnvsEVGJ7FopP3.YdPyD5iC','0','2','127.0.0.1','2025-01-07 09:56:09','','2024-12-30 17:22:08','','2025-01-07 09:56:08',NULL,NULL,NULL,NULL),(107,NULL,'fjx3205073','fjx3205073','00','','','0','','$2a$10$UIZXJBYjXD5y4YxO/6qqd.ExJAy.Ln3LBSdZSs13RTCM7pL2.B8Gq','0','2','127.0.0.1','2025-01-07 15:58:13','','2024-12-31 09:23:15','admin','2025-01-07 15:58:13',NULL,NULL,NULL,NULL),(108,NULL,'liming','liming','00','','','0','','$2a$10$MTMjtHhAMd3JiyGCewwIluy4C5oI6FxOw2sJKMP1b2ijUCZbpSbpW','0','2','127.0.0.1','2025-01-09 20:04:41','','2025-01-09 19:52:19','','2025-01-09 20:04:41',NULL,NULL,NULL,NULL);
...
INSERT INTO `sys_user_role` VALUES (1,1),(100,101),(101,101),(102,101),(103,102);
/*!40000 ALTER TABLE `sys_user_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'ry-ecs'
--
...
-- Dump completed on 2025-04-16 17:11:30
